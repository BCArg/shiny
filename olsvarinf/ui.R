...
headerPanel("Régression linéaire : conséquences de l'hétéroskédasticité pour l'inférence de β₁"), 
  conditionalPanel(
    ...
    h5(HTML("Paramètres de l'échantillonnage"))
      ,HTML("n : nombre d'observations par &eacute;chantillon&nbsp;:")
...
,h5(HTML("Param&egrave;tres de l'inf&eacute;rence"))
      ...
      ,br() 
      ,checkboxInput("seetheor",HTML("Afficher l'information th&eacute;orique"),TRUE)
      ,br()
	...
	list("Defaut" = "default", 
      ...
      ,HTML('<p>Détails sur l\'utilisation de cette ressource sur <a href="http://sites.uclouvain.be/selt/ressources/211473" target="_blank">Statistics eLearning Tools</a><br/> Code source disponible sur <a href="https://github.com/uclouvain-selt/shiny/tree/master/olsvarinf" target="_blank">Github</a></p>')
    )
  ),
